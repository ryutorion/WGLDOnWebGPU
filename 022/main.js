...
fn VS(in : VSIn) -> VSOut {
    ...
    var diffuse = clamp(dot(in.normal, (scene.lightDir * scene.iw).xyz), 0.0, 1);
    out.color = vec4<f32>(in.color.xyz * diffuse + scene.ambientColor.xyz, in.color.a);
...
const torusMesh = torus(32, 32, 1, 2);
...
const uniformBuffers = [
    device.createBuffer({
        size: wvp.byteLength + iw.byteLength + Float32Array.BYTES_PER_ELEMENT * 8,
