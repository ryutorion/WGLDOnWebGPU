...
fn VS(in : VSIn) -> VSOut {
    ...
    var diffuse = clamp(dot(in.normal, (scene.lightDir * scene.iw).xyz), 0.1, 1);
    out.color = vec4<f32>(in.color.xyz * diffuse, in.color.a);
...
const uniformBuffers = [
    device.createBuffer({
        size: wvp.byteLength + iw.byteLength + Float32Array.BYTES_PER_ELEMENT * 4,
